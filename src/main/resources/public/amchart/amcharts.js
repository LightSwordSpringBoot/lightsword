...
(function () {
    ...
    d.AxisBase = d.Class({
        construct: function (a) {
            ...
            var v, y = this.gridAlpha, x, u = this.choosePeriod(0), A = u.period, u = u.count, z = d.getPeriodDuration(A, u);
            ...
            if (0 < this.gridCountR)for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
                ...
                this.pushAxisItem(m);
                m = l = p;
                if (!isNaN(v))for (h = 1; h < u; h += v)this.gridAlpha = this.minorGridAlpha, f = p + x * h, f = d.resetDateToMin(new Date(f), A, v, t).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) * this.stepWidth, void 0, void 0, void 0, void 0, void 0, void 0, void 0, !0), this.pushAxisItem(f);
                this.gridAlpha = y
            }
    ...
    d.ValueAxis = d.Class({
        inherits: d.AxisBase, construct: function (a) {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)e = !0; else {
                ...
                var r = Math.round((this.maxCalc - this.minCalc) / this.step) + 1, v;
                ...
                if (this.autoGridCount || 0 !== this.gridCount)if ("date" == c)this.generateDFObject(), this.timeDifference = this.max - this.min, this.maxTime = this.lastTime = this.max, this.startTime = this.firstTime = this.min, this.parseDatesDraw(); else for (r >= this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), c = this.minCalc, h && (r++, c = this.maxCalc - r * y), this.gridCountReal = r, g = this.startCount = t; g < r; g += p)if (t = y * g + c, t = d.roundTo(t, this.maxDecCount + 1), !this.integersOnly || Math.round(t) == t)if (isNaN(x) || Number(d.toFixed(t, x)) == t) {
                    if (!0 === h)if (v > this.logGridLimit)t = Math.pow(10, g); else if (0 >= t && (t = c + y * g + y / 2, 0 >= t))continue;
                    ...
                    if (!isNaN(z) && 0 < A && g < r - 1) {
                        u = y / z;
                        h && (z = y * (g + p) + this.minCalc, z = d.roundTo(z, this.maxDecCount + 1), v > this.logGridLimit && (z = Math.pow(10, g + p)), u = 9, z = (z - t) / u);
                        f = this.gridAlpha;
                        this.gridAlpha = this.minorGridAlpha;
                        for (J = 1; J < u; J++) {
                            var H = this.getCoordinate(t + z * J), H = new this.axisItemRenderer(this,
                                H, "", !1, 0, 0, !1, !1, 0, !0);
                            this.pushAxisItem(H)
                        }
                        this.gridAlpha = f
...
(function () {
    ...
    d.RecItem = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            this.set = x;
            var u = a.axisThickness, A = a.axisColor, z = a.axisAlpha, B = a.tickLength, D = a.gridAlpha, C = a.gridThickness, J = a.gridColor, H = a.dashLength, S = a.fillColor, O = a.fillAlpha, Q = a.labelsEnabled;
            n = a.labelRotationR;
            var ga = a.counter, I = a.inside, aa = a.labelOffset, va = a.dx, ma = a.dy, Oa = a.orientation, Z = a.position, da = a.previousCoord, X = a.height, Aa = a.width, ea = a.offset, fa, Ba;
            ...
            var ha = "start";
            0 < h && (ha = "middle");
            a.centerLabels && (ha = "middle");
            var T = n * Math.PI / 180, Y, Da, G = 0, w = 0, na = 0, ia = Y = 0, Pa = 0;
            "V" == Oa && (n = 0);
            var ca;
            Q && "" !== c && (ca = a.autoWrap && 0 === n ? d.wrappedText(y, c, v, t, r, ha, k, Math.abs(h), 0) : d.text(y, c, v, t, r, ha, k), ha = ca.getBBox(), ia = ha.width, Pa = ha.height);
            if ("H" == Oa) {
                if (0 <= b && b <= Aa + 1 && (0 < B && 0 < z && b + l <= Aa + 1 && (fa = d.line(y, [b + l, b + l], [0, B], A, z, C), x.push(fa)), 0 < D && (Ba = d.line(y, [b, b + va, b + va], [X, X + ma, ma], J, D, C, H), x.push(Ba))), w = 0, G = b, g && 90 == n && I && (G -= r), !1 === e ? (ha = "start", w = "bottom" == Z ? I ? w + B : w - B : I ? w - B : w + B, G += 3, 0 < h && (G += h / 2 - 3, ha = "middle"), 0 < n && (ha = "middle")) : ha = "middle", 1 == ga && 0 < O && !g && !m && da < Aa && (e = d.fitToBounds(b, 0, Aa), da = d.fitToBounds(da, 0, Aa), Y = e - da, 0 < Y && (Da = d.rect(y, Y, a.height, S, O), Da.translate(e - Y + va, ma), x.push(Da))), "bottom" == Z ? (w += X + r / 2 + ea, I ? (0 < n ? (w = X - ia / 2 * Math.sin(T) - B - 3, G += ia / 2 * Math.cos(T) - 4 + 2) : 0 > n ? (w = X + ia * Math.sin(T) - B - 3 + 2, G += -ia * Math.cos(T) - Pa * Math.sin(T) - 4) : w -= B + r + 3 + 3, w -= aa) : (0 < n ? (w = X + ia / 2 * Math.sin(T) + B + 3, G -= ia / 2 * Math.cos(T)) : 0 > n ? (w = X + B + 3 - ia / 2 * Math.sin(T) + 2, G += ia / 2 * Math.cos(T)) : w += B + u + 3 + 3, w += aa)) : (w += ma + r / 2 - ea, G += va, I ? (0 < n ? (w = ia / 2 * Math.sin(T) + B + 3, G -= ia / 2 * Math.cos(T)) : w += B + 3, w += aa) : (0 < n ? (w = -(ia / 2) * Math.sin(T) - B - 6, G += ia / 2 * Math.cos(T)) : w -= B + r + 3 + u + 3, w -= aa)), "bottom" == Z ? Y = (I ? X - B - 1 : X + u - 1) + ea : (na = va, Y = (I ? ma : ma - B - u + 1) - ea), f && (G += f), r = G, 0 < n && (r += ia / 2 * Math.cos(T)), ca && (f = 0, I && (f = ia / 2 * Math.cos(T)), r + f > Aa + 2 || 0 > r))ca.remove(), ca = null
            } else {
                0 <= b && b <= X + 1 && (0 < B && 0 < z && b + l <= X + 1 && (fa = d.line(y, [0, B + 1], [b + l, b + l], A, z, C), x.push(fa)), 0 < D && (Ba = d.line(y, [0, va, Aa + va], [b, b + ma, b + ma], J, D, C, H), x.push(Ba)));
                ha = "end";
                if (!0 === I && "left" == Z || !1 === I && "right" == Z)ha = "start";
                w = b - Pa / 2 + 2;
                1 == ga && 0 < O && !g && !m && (e = d.fitToBounds(b, 0, X), da = d.fitToBounds(da, 0, X), T = e - da, Da = d.polygon(y, [0, a.width, a.width, 0], [0, 0, T, T], S, O), Da.translate(va, e - T + ma), x.push(Da));
                w += r / 2;
                "right" == Z ? (G += va + Aa + ea, w += ma, I ? (f || (w -= r / 2 + 3), G = G - (B + 4) - aa) : (G += B + 4 + u, w -= 2, G += aa)) : I ? (G += B + 4 - ea, f || (w -= r / 2 + 3), g && (G += va, w += ma), G += aa) : (G += -B - u - 4 - 2 - ea, w -= 2, G -= aa);
            ...
            ca && (ca.attr({"text-anchor": ha}), ca.translate(G, w, NaN, !0), 0 !== n && ca.rotate(-n, a.chart.backgroundColor), a.allLabels.push(ca), this.label = ca, d.setCN(p, ca, a.bcn + "label"), d.setCN(p, ca, q, !0), g && d.setCN(p, ca, "guide"));
            Ba && (d.setCN(p, Ba, a.bcn + "grid"), d.setCN(p, Ba, q, !0), g && d.setCN(p, Ba, "guide"));
            Da && (d.setCN(p, Da, a.bcn + "fill"), d.setCN(p, Da, q, !0));
            m ? Ba && d.setCN(p, Ba, a.bcn + "grid-minor") : (a.counter = 0 === ga ? 1 : 0, a.previousCoord = b);
...
(function () {
    ...
    d.AmChart = d.Class({
        construct: function (a) {
            ...
            var a = this.div;
            if (a) {
                var b = this.chartDiv, c = a.offsetWidth, e = a.offsetHeight, h = this.container, c = d.removePx(d.getStyle(a, "padding-left")), e = d.removePx(d.getStyle(a, "padding-right")), f = d.removePx(d.getStyle(a, "padding-top")), g = d.removePx(d.getStyle(a, "padding-bottom"));
                isNaN(c);
                isNaN(e);
                isNaN(f);
                isNaN(g);
            ...
            a = {
                text: a, size: b, color: c, alpha: e, bold: d,
                enabled: !0
            };
            this.titles.push(a);
            return a
        ...
        construct: function (a) {
            ...
            for (m = this.start; m <= this.end; m++) {
                ...
                if (isNaN(q))this.connect || (this.drawLineGraph(b, c, e, d), b = [], c = [], e = [], d = []); else {
                    ...
                    c.push(t);
                    if (!isNaN(p)) {
                        var v = this.valueAxis.getCoordinate(p, this.noRounding) - this.height, v = v * this.valueAxis.rMultiplier, y = v * Math.sin(r / 180 * Math.PI), r = v * Math.cos(r / 180 * Math.PI);
                        e.push(y);
                        d.push(r);
                        isNaN(k) && (k = y);
                        isNaN(l) && (l = r)
                    ...
                    n.x = q;
                    n.y = t;
                    if (y = this.labelText)y = this.createLabel(n, y), v = 0, r && (v = r.size), this.positionLabel(n, q, t, y, v);
                    isNaN(f) && (f = q);
                    isNaN(g) && (g = t)
                }
            }
            ...
            if (e) {
                ...
                var t = a.columnGraphics, r = 0, v = 0;
                t && (r = t.x, v = t.y);
            ...
            isNaN(k) && (k = .8);
            var m = this.useNegativeColorIfDown, n = this.width, q = this.height, p = this.y, t = this.rotate, r = this.columnCount, v = d.toCoordinate(this.cornerRadiusTop, k / 2), y = this.connect, x = [], u = [], A, z, B, D, C = this.chart.graphs.length, J, H = this.dx / this.tcc, S = this.dy / this.tcc, O = f.stackType, Q = this.start, ga = this.end, I = this.scrollbar, aa = "graph-column-";
            I && (aa = "scrollbar-graph-column-");
            var va = this.categoryAxis, ma = this.baseCoord, Oa = this.negativeBase, Z = this.columnIndex, da = this.lineThickness, X = this.lineAlpha, Aa = this.lineColorR, ea = this.dashLength, fa = this.set, Ba, ha = this.getGradRotation(), T = this.chart.columnSpacing, Y = va.cellWidth, Da = (Y * k - r) / r;
            T > Da && (T = Da);
            var G, w, na, ia = q, Pa = n, ca = 0, tb = 0, ub, vb, gb, hb, wb = this.fillColorsR, Qa = this.negativeFillColors, Ja = this.negativeLineColor, Ya = this.fillAlphas, Za = this.negativeFillAlphas;
            ...
            if (!(I || "line" != g && "smoothedLine" != g && "step" != g || (1 == e.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), !Qa && void 0 == Ja || m))) {
                ...
                t ? (ia = q, Pa = Math.abs(Lb - Ka), ub = q, vb = Math.abs(ib - Ka), hb = tb = 0, f.reversed ? (ca = 0, gb = Ka) : (ca = Ka, gb = 0)) : (Pa = n, ia = Math.abs(Lb - Ka), vb = n, ub = Math.abs(ib - Ka), gb = ca = 0, f.reversed ? (hb = p, tb = Ka) : hb = Ka)
            }
            var La = Math.round;
            this.pmx = La(ca);
            this.pmy = La(tb);
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g) {
                if (0 < Q) {
                    ...
                    if (this.lineColorField)for (L =
                                                     Q; -1 < L; L--)if (G = e[L], w = G.axes[f.id].graphs[b], w.lineColor) {
                ...
                if (ga < e.length - 1)for (L = ga + 1; L < e.length; L++)if (G = e[L], w = G.axes[f.id].graphs[b], na = w.values.value, !isNaN(na)) {
                    ga = L;
                    break
                }
            }
            ...
            for (L = Q; L <= ga; L++) {
                ...
                var R, P, K, ba, ja = NaN, E = NaN, F = NaN, N = NaN, M = NaN, pa = NaN, qa = NaN, ra = NaN, sa = NaN, wa = NaN, Ea = NaN, ka = NaN, la = NaN, W = NaN, zb = NaN, Ab = NaN, ta = NaN, ua = void 0, Ma = wb, Va = Ya, Ga = Aa, Ca, xa, Bb = this.proCandlesticks, mb = this.topRadius, Fa = q - 1, oa = n - 1, bb = this.pattern;
                ...
                if (Ia) {
                    ...
                    var ya = Math.floor(Y / 2) + Math.floor(Wa * Y / 2), Ha = ya, nb = 0;
                    ...
                    if (!Bb && W < ta || Bb && W < Ba)w.isNegative = !0, Qa && (Ma = Qa), Za && (Va = Za), void 0 != Ja && (Ga = Ja);
                    $a = !1;
                    isNaN(W) || (m ? W > Ta ? (Sa && ($a = !0), Sa = !1) : (Sa || ($a = !0), Sa = !0) : w.isNegative = W < Oa ? !0 : !1, Ba = W);
                    var Ob = !1;
                    I && a.chartScrollbar.ignoreCustomColors && (Ob = !0);
                    Ob || (void 0 != w.color && (Ma = w.color), w.fillColors && (Ma = w.fillColors));
                    switch (g) {
                        case"line":
                            if (isNaN(W))y || (this.drawLineGraph(x, u, U, V), x = [], u = [], U = [], V = []); else {
                        ...
                        case"smoothedLine":
                            if (isNaN(W))y || (this.drawSmoothedGraph(x, u, U, V), x = [], u = [], U = [], V = []); else {
                                ...
                                la = F;
                                !Ra || isNaN(M) || isNaN(N) || (U.push(N), V.push(M));
                                void 0 == w.lineColor && void 0 == w.fillColors && isNaN(w.dashLength) || (this.drawSmoothedGraph(x, u, U, V), x = [E], u = [F], U = [], V = [], !Ra || isNaN(M) || isNaN(N) || (U.push(N), V.push(M)), this.lineColorSwitched = w.lineColor, this.fillColorsSwitched = w.fillColors, this.dashLengthSwitched = w.dashLength);
                                w.gap && (this.drawSmoothedGraph(x, u, U, V), x = [], u = [], U = [], V = [])
                            }
                            break;
                        case"step":
                            if (!isNaN(W)) {
                                t ? (isNaN(A) || (x.push(A), u.push(F - ya)), u.push(F - ya), x.push(E), u.push(F + Ha), x.push(E), !Ra || isNaN(M) || isNaN(N) || (isNaN(B) || (U.push(B), V.push(M - ya)), U.push(N), V.push(M - ya), U.push(N), V.push(M + Ha))) : (isNaN(z) || (u.push(z), x.push(E - ya)), x.push(E - ya), u.push(F), x.push(E + Ha), u.push(F), !Ra || isNaN(M) || isNaN(N) || (isNaN(D) || (U.push(N - ya), V.push(D)), U.push(N - ya), V.push(M), U.push(N + Ha), V.push(M)));
                                A = E;
                                z = F;
                                B = N;
                                D = M;
                                ...
                                ka = E;
                                la = F;
                                if ($a || void 0 != w.lineColor || void 0 != w.fillColors || !isNaN(w.dashLength) && L < ga) {
                                    var Pb = x[x.length - 2], dc = u[u.length - 2];
                                    x.pop();
                                    u.pop();
                                    U.pop();
                                    V.pop();
                                    this.drawLineGraph(x, u, U, V);
                                    x = [Pb];
                                    u = [dc];
                                    t ? (u.push(F + Ha), x.push(E)) : (x.push(E + Ha), u.push(F));
                                    U = [Pb];
                                    V = [D];
                                ...
                                if (Nb || w.gap)A = z = NaN, this.drawLineGraph(x, u, U, V), x = [], u = [], U = [], V = []
                            } else if (!y) {
                        ...
                        case"column":
                            ...
                            if (!isNaN(W)) {
                                ...
                                w.isNegative && (Qa && (Ma = Qa), void 0 != Ja && (Ca = Ja));
                                ...
                                if (!(W < Qb && ob < Qb || W > Rb && ob > Rb)) {
                                    ...
                                    if (t) {
                                        ...
                                        K = d.roundTo(K, 2);
                                        ba = d.roundTo(ba, 2);
                                        P < q && 0 < K && (ua = new d.Cuboid(h, ba, K, H - a.d3x, S - a.d3y, Ma, Va, da, Ca, X, ha, v, t, ea, bb, mb, aa), w.columnWidth = Math.abs(ba), w.columnHeight = Math.abs(K))
                                    } else {
                                        ...
                                        K = d.roundTo(K, 2);
                                        ba = d.roundTo(ba, 2);
                                        R < n + Z * H && 0 < K && (this.showOnAxis && (P -= S / 2), ua = new d.Cuboid(h, K, ba, H - a.d3x, S - a.d3y, Ma, Va, da, Ca, this.lineAlpha, ha, v, t, ea, bb, mb, aa), w.columnHeight = Math.abs(ba), w.columnWidth = Math.abs(K))
                                    }
                                }
                                if (ua) {
                                    xa = ua.set;
                                    ...
                                    P = d.roundTo(P, 2);
                                    xa.translate(R, P);
                                    (w.url || this.showHandOnHover) && xa.setAttr("cursor", "pointer");
                                    if (!I) {
                                        "none" == O && (J = t ? (this.end + 1 - L) * C - c : C * L + c);
                                        "3d" == O && (t ? (J = (this.end + 1 - L) * C - c - 1E3 * this.depthCount, wa += H * Z, ka += H * Z, w.y += H * Z) : (J = (C - c) * (L + 1) + 1E3 * this.depthCount, Ea += S * Z, la += S * Z, w.y += S * Z));
                            ...
                            if (!isNaN(ta) && !isNaN(W)) {
                                ...
                                if (t) {
                                    ...
                                    if (P < q && 0 < K) {
                                        ...
                                        ba = E - N;
                                        ua = new d.Cuboid(h, ba, K, H, S, Ma, Ya, da, Ca, X, ha, v, t, ea, bb, mb, aa)
                                    }
                                } else {
                                    "open" == l && (la = M);
                                    "high" == l && (la = sa);
                                    ...
                                    if (R < n && 0 < K) {
                                        Bb && W >= ta && (Va = 0);
                                        var ua = new d.Cuboid(h, K, ba, H, S, Ma, Va, da, Ca, X, ha, v, t, ea, bb, mb, aa), Fb, Gb;
                                        W > ta ? (Fb = [F, sa], Gb = [M, qa]) : (Fb = [M, sa], Gb = [F, qa]);
                                        !isNaN(sa) && !isNaN(qa) && E < n && 0 < E && (Xa = d.line(h, [E, E], Fb, Ca, X, da), cb = d.line(h, [E, E], Gb, Ca, X, da), d.setCN(a, Xa, this.bcn + "line-high"), w.className && d.setCN(a, Xa, w.className, !0), d.setCN(a, cb, this.bcn + "line-low"), w.className && d.setCN(a, cb, w.className, !0))
                                    }
                                }
                                ua && (xa = ua.set, w.columnGraphics = xa, fa.push(xa), xa.translate(R, P - da / 2), (w.url || this.showHandOnHover) && xa.setAttr("cursor", "pointer"), Xa && (fa.push(Xa), fa.push(cb)), I || (w.x = t ? P + K / 2 : R + K / 2, this.animateColumns(ua, L, E, N, F, M), this.addListeners(xa, w), void 0 !== this.tabIndex && xa.setAttr("tabindex", this.tabIndex)))
                            }
                            break;
                        case"ohlc":
                            if (!(isNaN(ta) || isNaN(zb) || isNaN(Ab) || isNaN(W))) {
                                var Sb = h.set();
                                fa.push(Sb);
                                W < ta && (w.isNegative = !0, void 0 != Ja && (Ga = Ja));
                                void 0 != w.lineColor && (Ga = w.lineColor);
                                var pb, qb, rb;
                                if (t) {
                                    la = F;
                                    ka = E;
                                    ...
                                    if (0 === E && 0 === N && 0 === pa && 0 === ra)continue;
                                    if (E == oa && N == oa && pa == oa && ra == oa)continue;
                                    var Hb = F - k / 2, Hb = d.fitToBounds(Hb, 0, q), Tb = d.fitToBounds(F, 0, q), Ib = F + k / 2, Ib = d.fitToBounds(Ib, 0, q);
                                    0 <= N && N <= oa && (qb = d.line(h, [N, N], [Hb, Tb], Ga, X, da, ea));
                                    0 < F && F < q && (pb = d.line(h, [pa, ra], [F, F], Ga, X, da, ea));
                                    0 <= E && E <= oa && (rb = d.line(h, [E, E], [Tb, Ib], Ga, X, da, ea))
                                } else {
                                    la = F;
                                    "open" == l && (la = M);
                                    "high" == l && (la = sa);
                                    "low" == l && (la = qa);
                                    var ka = E, qa = d.fitToBounds(qa, 0, Fa), sa = d.fitToBounds(sa, 0, Fa), Jb = E - k / 2, Jb = d.fitToBounds(Jb, 0, n), Ub = d.fitToBounds(E, 0, n), Kb = E + k / 2, Kb = d.fitToBounds(Kb, 0, n);
                                    0 <= M && M <= Fa && (qb = d.line(h, [Jb, Ub], [M, M], Ga, X, da, ea));
                                    0 < E && E < n && (pb = d.line(h, [E, E], [qa, sa], Ga, X, da, ea));
                                    0 <= F && F <= Fa && (rb = d.line(h, [Ub, Kb], [F, F], Ga, X, da, ea))
                                }
                                fa.push(qb);
                                fa.push(pb);
                                fa.push(rb);
                    ...
                    if (!I && !isNaN(W)) {
                        ...
                        if (this.end - this.start <= Vb || 0 === Vb) {
                            var Wb = this.createBullet(w, ka, la, L), Xb = this.labelText;
                            if (Xb && !isNaN(wa) && !isNaN(wa)) {
                                var gc = this.createLabel(w, Xb), Yb = 0;
                                Wb && (Yb = Wb.size);
                                this.positionLabel(w, wa, Ea, gc, Yb)
                            }
                            if ("regular" == O || "100%" == O) {
                                var Zb = f.totalText;
                                if (Zb) {
                                    var Na = this.createLabel(w, Zb, f.totalTextColor);
                                    d.setCN(a, Na, this.bcn + "label-total");
                                    this.allBullets.push(Na);
                                    if (Na) {
                                        var $b = Na.getBBox(), ac = $b.width, bc = $b.height, db, eb, sb = f.totalTextOffset, cc = f.totals[L];
                                        cc && cc.remove();
                                        var fb = 0;
                                        "column" != g && (fb = this.bulletSize);
                                        t ? (eb = Ea, db = 0 > W ? E - ac / 2 - 2 - fb - sb : E + ac / 2 + 3 + fb +
                                        sb) : (db = wa, eb = 0 > W ? F + bc / 2 + fb + sb : F - bc / 2 - 3 - fb - sb);
                                        Na.translate(db, eb);
                                        f.totals[L] = Na;
            ...
            this.lastDataItem = w;
            if ("line" == g || "step" == g || "smoothedLine" == g)"smoothedLine" == g ? this.drawSmoothedGraph(x, u, U, V) : this.drawLineGraph(x, u, U, V), I || this.launchAnimation();
            ...
            if (1 < a.length) {
                ...
                v && (t = v);
                var v = h.fillColorsR, y = h.fillColorsSwitched;
                y && (v = y);
                var x = h.dashLength;
            ...
            if (1 < a.length) {
                ...
                h.push(l);
                h.push(k);
                var m = this.lineAlpha, n = this.lineThickness, h = this.dashLength, q = this.fillAlphas, p = this.lineColorR, t = this.fillColorsR, r = this.negativeLineColor, v = this.negativeFillColors, y = this.negativeFillAlphas, x = this.baseCoord, u = this.lineColorSwitched;
                u && (p = u);
            ...
            if (k) {
                ...
                if (n.mouseIsOver) {
                    ...
                    if (this.resizingRight) {
                        if (m)if (a = r - e, !isNaN(this.maxHeight) && a > this.maxHeight && (a = this.maxHeight), a + e > p + f && (a = p - e + f), 0 > a)this.resizingRight = !1, b = this.resizingLeft = !0; else {
                            if (0 === a || isNaN(a))a = .1;
                            g.setAttr("height", a)
                    ...
                    if (this.resizingLeft) {
                        if (m)if (c = e, e = r, e < f && (e = f), isNaN(e) && (e = f), e > p + f && (e = p + f), a = !0 === b ? c - e : k + c - e, !isNaN(this.maxHeight) && a > this.maxHeight && (a = this.maxHeight, e = c), 0 > a)this.resizingRight = !0, this.resizingLeft = !1, g.setAttr("y", c + k - f); else {
                            if (0 === a || isNaN(a))a = .1;
                            g.setAttr("y", e - f);
                            g.setAttr("height", a)
            ...
            if (a.enabled) {
                ...
                if ((m = a.graph) && a.catScrollbar) {
                    ...
                    for (t = 0; t < c.length; t++) {
                        var r = c[t].axes[p.id].graphs[m.id].values, v;
        ...
        construct: function (a) {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    var r = this.horizontalPadding, v = this.verticalPadding, y = this.pointerWidth, x = this.pointerOrientation, u = this.cornerRadius, A = c.fontFamily, z = this.fontSize;
                    ...
                    "H" != x ? (D = a - C / 2, b < k + A + 10 && "down" != x ? (S = !0, e && (b += z), z = b + y, this.deltaSignY = -1) : (e && (b -= z), z = b - A - y, this.deltaSignY = 1)) : (2 * y > A && (y = A / 2), z = b - A / 2, a < g + (l - g) / 2 ? (D = a + y, this.deltaSignX = -1) : (D = a - C - y, this.deltaSignX = 1));
                    z + A >= m && (z = m - A);
                    z < k && (z = k);
                    D < g && (D = g);
                    D + C > l && (D = l - C);
                    var k = z + v, m = D + r, O = this.shadowAlpha, Q = this.shadowColor, r = this.borderThickness, ga = this.bulletSize, I, v = this.fillAlpha, aa = this.borderAlpha;
                    this.showBullet && (I = d.circle(h, ga, t, v), f.push(I));
                    this.drop ? (g = C / 1.6, l = 0, "V" == x && (x = "down"), "H" == x && (x = "left"), "down" == x && (D = a + 1, z = b - g - g / 3), "up" == x && (l = 180, D = a + 1, z = b + g + g / 3), "left" == x && (l = 270, D = a + g + g / 3 + 2, z = b), "right" == x && (l = 90, D = a - g - g / 3 + 2, z = b), k = z - H / 2 + 1, m = D - J / 2 - 1, q = d.drop(h, g, l, q, v, r, p, aa)) : 0 < u || 0 === y ? (0 < O && (a = d.rect(h, C, A, q, 0, r +
                ...
                for (J = 0; J < C.length; J++) {
                    ...
                    for (S = 0; S < h.length; S++) {
                        ...
                        if (b.valueAxis.id == H) {
                            ...
                            var aa = D;
                            b.dataProvider && (aa = f);
                            I.values = this.processValues(aa, b, ga);
                            !b.connect && z && z[O] && 0 < Q && B.time - v[O] >= y * Q && (z[O].gap = !0);
...
(function () {
    ...
    d.TrendLine = d.Class({
        construct: function (a) {
            ...
            var a = this;
            a.destroy();
            var b = a.chart, c = b.container, e, h, f, g, k = a.categoryAxis, l = a.initialDate, m = a.initialCategory, n = a.finalDate, q = a.finalCategory, p = a.valueAxis, t = a.valueAxisX, r = a.initialXValue, v = a.finalXValue, y = a.initialValue, x = a.finalValue, u = p.recalculateToPercents, A = b.dataDateFormat;
...
(function () {
    ...
    d.drop = function (a, b, c, d, h, f, g, k) {
        var l = 1 / 180 * Math.PI, m = c - 20, n = Math.sin(m * l) * b, q = Math.cos(m * l) * b, p = Math.sin((m + 40) * l) * b, t = Math.cos((m + 40) * l) * b, r = .8 * b, v = -b / 3, y = b / 3;
        0 === c && (v = -v, y = 0);
        180 == c && (y = 0);
        90 == c && (v = 0);
        270 == c && (v = 0, y = -y);
    ...
    d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
        ...
        g = r(g);
        k = r(k);
        var v = r(g / f * k), y = d.VML, x = 359.5 + f / 100;
        359.94 < x && (x = 359.94);
        h >= x && (h = x);
        var u = 1 / 180 * Math.PI, x = b + Math.sin(e * u) * k, A = c - Math.cos(e * u) * v, z = b + Math.sin(e * u) * f, B = c - Math.cos(e * u) * g, D = b + Math.sin((e + h) * u) * f, C = c - Math.cos((e + h) * u) * g, J = b + Math.sin((e + h) * u) * k, u = c - Math.cos((e + h) * u) * v, H = {
        ...
        e = a.set();
        var O;
        y && (x = r(10 * x), z = r(10 * z), D = r(10 * D), J = r(10 * J), A = r(10 * A), B = r(10 * B), C = r(10 * C), u = r(10 * u), b = r(10 * b), l = r(10 * l), c = r(10 * c), f *= 10, g *= 10, k *= 10, v *= 10, 1 > Math.abs(h) && 1 >= Math.abs(D - z) && 1 >= Math.abs(C - B) && (O = !0));
        h = "";
        var Q;
        q && (H["fill-opacity"] = 0, H["stroke-opacity"] = m["stroke-opacity"] / 2, H.stroke = m.stroke);
        if (0 < l) {
            Q = " M" + x + "," + (A + l) + " L" + z + "," + (B + l);
            y ? (O || (Q += " A" + (b - f) + "," + (l + c - g) + "," + (b + f) + "," + (l + c + g) + "," + z + "," + (B + l) + "," + D + "," + (C + l)), Q += " L" + J + "," + (u + l), 0 < k && (O || (Q += " B" + (b - k) + "," + (l + c - v) + "," + (b + k) + "," +
                (l + c + v) + "," + J + "," + (l + u) + "," + x + "," + (l + A)))) : (Q += " A" + f + "," + g + ",0," + S + ",1," + D + "," + (C + l) + " L" + J + "," + (u + l), 0 < k && (Q += " A" + k + "," + v + ",0," + S + ",0," + x + "," + (A + l)));
            Q += " Z";
            var ga = l;
            y && (ga /= 10);
            for (var I = 0; I < ga; I += 10) {
                var aa = a.path(Q, void 0, void 0, "1000,1000").attr(H);
                e.push(aa);
                aa.translate(0, -I)
            }
            Q = a.path(" M" + x + "," + A + " L" + x + "," + (A + l) + " L" + z + "," + (B + l) + " L" + z + "," + B + " L" + x + "," + A + " Z", void 0, void 0, "1000,1000").attr(H);
            l = a.path(" M" + D + "," + C + " L" + D + "," + (C + l) + " L" + J + "," + (u + l) + " L" + J + "," + u + " L" + D + "," + C + " Z", void 0, void 0, "1000,1000").attr(H);
            e.push(Q);
            e.push(l)
        }
        y ? (O || (h = " A" + r(b - f) + "," + r(c - g) + "," + r(b + f) + "," + r(c + g) + "," + r(z) + "," + r(B) + "," + r(D) + "," + r(C)), g = " M" + r(x) + "," + r(A) + " L" + r(z) + "," + r(B) + h + " L" + r(J) + "," + r(u)) : g = " M" + x + "," + A + " L" + z + "," + B + (" A" + f + "," + g + ",0," + S + ",1," + D + "," + C) + " L" + J + "," + u;
        0 < k && (y ? O || (g += " B" + (b - k) + "," + (c - v) + "," + (b + k) + "," + (c + v) + "," + J + "," + u + "," + x + "," + A) : g += " A" + k + "," + v + ",0," + S + ",0," + x + "," + A);
...
(function () {
    ...
    d.AmLegend = d.Class({
        construct: function (a) {
            ...
            for (A = 0; A < x.length; A++) {
                var J = x[A];
                this.reversedOrder && (J = x[x.length - A - 1]);
                u = J.getBBox();
                var H;
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                c.accessible && b.accessibleLabel && (v = d.massReplace(b.accessibleLabel, {"[[title]]": a.title}), c.makeAccessible(n, v));
                v = b.fontSize;
