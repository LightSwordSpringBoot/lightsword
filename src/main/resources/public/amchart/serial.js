        ...
        inherits: e.AmRectangularChart, construct: function (a) {
            ...
            if (b) {
                ...
                for (var l = 0; l < c.length; l++) {
                    for (var k = c[l], m = 0, p = 0, n = 0, r = 0, w, y, u, q, E, v, t, x, B, A, G = this.start; G <= this.end; G++) {
                        var D = h[G];
                        if (D) {
    ...
    e.CategoryAxis = e.Class({
        inherits: e.AxisBase, construct: function (a) {
            ...
            if (e.ifArray(a)) {
                ...
                if (this.parseDates && !this.equalSpacing)this.lastTime = a[a.length - 1].time, this.maxTime = e.resetDateToMin(new Date(this.lastTime + 1.05 * r), this.minPeriod, 1, p).getTime(), this.timeDifference = this.endTime - this.startTime, this.parseDatesDraw(); else if (!this.parseDates) {
